...
export abstract class Element<Node extends AbstractNode = AbstractNode> extends Logger {
	...
	public async completionCapability(context: CapabilityContext<Node>): Promise<CompletionItem[] | undefined> {
		return undefined
	}

	public async definitionCapability(context: CapabilityContext<Node>): Promise<Location[] | LocationLink[] | undefined> {
		return undefined
	}
